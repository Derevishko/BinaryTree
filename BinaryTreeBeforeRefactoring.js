class BinaryTree {
  ...
  insert(str) {
    ...
    !this.data.value
      ? (this.data.value = newObj.value)
      : (this.data = this.check(newObj, this.data));
  }
  ...
  check(newObj, obj) {
    ...
    newObj.value < obj.value
      ? (obj.left = this.check(newObj, obj.left))
  ...
  replaceStep2(obj, block, flag) {
    ...
    nextObj
      ? this.replaceStep2(nextObj, block, flag)
      : this.paste(obj, block, flag);
  }
